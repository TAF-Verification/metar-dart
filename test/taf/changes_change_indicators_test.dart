...
void main() {
  ...
  test('Test three changes', () {
    ...
    expect(change0.changeIndicator.code, 'TEMPO');
    expect(change0.changeIndicator.translation, 'temporary');

    final change1 = changes[1];
    expect(change1.code, 'BECMG 0700/0702 26006G12MPS');
    expect(change1.changeIndicator.code, 'BECMG');
    expect(change1.changeIndicator.translation, 'becoming');

    final change2 = changes[2];
    expect(change2.code, 'BECMG 0708/0710 27007G13MPS');
    expect(change2.changeIndicator.code, 'BECMG');
    expect(change2.changeIndicator.translation, 'becoming');
  ...
  test('Test six changes', () {
    ...
    expect(change3.changeIndicator.code, 'PROB30');
    expect(change3.changeIndicator.translation, 'probability 30%');

    final change4 = changes[4];
    expect(change4.code, 'FM072100 24015G25KT 6SM -SHRA BR BKN035');
    expect(change4.changeIndicator.code, 'FM072100');
    expect(change4.changeIndicator.translation,
        'from 2018-10-07 21:00:00 until 2018-10-08 00:00:00');

    final change5 = changes[5];
    expect(change5.code, 'PROB30 TEMPO 0721/0724 4SM TSRA BR OVC025CB');
    expect(change5.changeIndicator.code, 'PROB30 TEMPO');
    expect(change5.changeIndicator.translation, 'probability 30% temporary');
